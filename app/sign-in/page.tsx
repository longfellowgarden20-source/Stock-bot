...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0c1211] flex items-center justify-center px-4">
        ...
        <div className="bg-white/4 border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              { icon: BarChart2, label: 'Multi-source convergence alerts', color: 'text-[#14b8a6]' },
          ...
          <form onSubmit={signIn} className="flex flex-col gap-3">
            <input
              ...
              required
              autoFocus
              className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-slate-500 focus:outline-none focus:border-[#14b8a6]/60 text-sm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center py-3.5 rounded-xl font-semibold text-sm text-white bg-[#14b8a6] hover:bg-[#2dd4bf] disabled:opacity-50 active:scale-[0.98]"
